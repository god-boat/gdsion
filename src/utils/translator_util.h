...
class TranslatorUtil {
	...
	static int _sanitize_param_loop(int p_value, int p_min, int p_max, const String &p_label);
	static int _sanitize_param_clamp(int p_value, int p_min, int p_max, const String &p_label);
	static int _get_params_algorithm(int (&p_algorithms)[4][16], int p_operator_count, int p_data_value, int p_max_value, const String &p_command);

	static void _set_siopm_params_by_array(const Ref<SiOPMChannelParams> &p_params, Vector<int> p_data);
...
public:
	...
	static void parse_siopm_params(const Ref<SiOPMChannelParams> &p_params, const String &p_data_string);
	...
	static Vector<int> get_siopm_params(const Ref<SiOPMChannelParams> &p_params);
